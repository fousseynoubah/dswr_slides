...
nom <- "Keïta"
prenom <- "Mobido"
# Désormais, c'est informations sont stockées dans notre environnement.
...
knitr::asis_output("\\tiny")
# Enrichissons notre environnement des objets addtionnels
...
# Illustration d'un propriété des objets: le comportement
...
```{r, echo=c(-1, -21), warning=TRUE, message=TRUE}
knitr::asis_output("\\tiny")
